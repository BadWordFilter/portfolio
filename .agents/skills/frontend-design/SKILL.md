...
description: Frontend Design — Distinctive, Production-Grade UI & interaction quality skill. Use when building or improving any web UI.
source: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/frontend-design
---
...
## When to Use
Use this skill when building or improving any frontend UI — especially portfolios, landing pages, dashboards, or any interface where visual quality matters.
